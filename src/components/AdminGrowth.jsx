...
export default function AdminGrowth({ leads = [], products = [], config = {} }) {
  ...
  const attn = useMemo(() => {
    ...
    const NOME_ELEMENTO = { banner: 'Banner principal', cupom_boas_vindas: 'Cupom de boas-vindas', subbanner: 'Sub-banner', caimento: 'Caimento (calça jogador)', meu_numero: 'Chip "Seu nº" no card' };
