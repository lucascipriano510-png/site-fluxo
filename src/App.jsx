...
import MaqueteHero from './components/MaqueteHero';
...
function App() {
  ...
  return (
    <div className="app-shell brilho-ambient min-h-dvh font-sans text-white pb-0 selection:bg-emerald-500 selection:text-zinc-950">
      ...
      {/* TESTE (branch fx/hero-imersivo): maquete 3D da fachada construída
          pelo scroll, no lugar do carrossel. Pra voltar: <BannerCarousel/>. */}
      <MaqueteHero />
